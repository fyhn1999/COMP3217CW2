...
# Read the training data from 'TrainingDataMulti.csv' without header
...
# Read the testing data from 'TestingDataMulti.csv' without header
...
# Save the test results to 'TestingResultsMulti.csv' without header
test_results.to_csv('TestingResultsMulti.csv', index=False, header=False)
